...
| <code><a href="#cdk-global-parameter.GlobalStringParameter.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk-global-parameter.GlobalStringParameter.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk-global-parameter.GlobalStringParameter.with.parameter.mixins"></a>
